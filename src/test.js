function loadMenuContent() {
    ...
    menuBtn.addEventListener("click", () => {
        ...
        donutsContent.textContent = "Earth donuts are sweet. Our space donuts are savory, the are flavored by minerals that can only be sourced from the rings of Saturn.";
